...
export const stations: Station[] = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 16,
        questionAr: "أَكْمِلْ: أَنَا ______ جَدِيدٌ.",
        questionEn: "Complete: I ... my ... is new. (أَنَا + كِتَاب)",
        type: "mcq",
        options: [
          { ar: "كِتَابِي", en: "kitābī (my book)" },
          { ar: "كِتَابُكَ", en: "kitābuka (your book - masc.)" },
          { ar: "كِتَابُنَا", en: "kitābunā (our book)" },
        ],
        correctAnswer: 0,
      },
      {
        id: 17,
        questionAr: "أَكْمِلْ: نَحْنُ ______ كَبِيرٌ.",
        questionEn: "Complete: We ... our ... is big. (نَحْنُ + بَيْت)",
        type: "mcq",
        options: [
          { ar: "بَيْتِي", en: "baytī (my house)" },
          { ar: "بَيْتُنَا", en: "baytunā (our house)" },
          { ar: "بَيْتُهُ", en: "baytuhu (his house)" },
        ],
        correctAnswer: 1,
      },
      {
        id: 18,
        questionAr: "أَكْمِلْ: أَنْتَ ______ جَمِيلَةٌ.",
        questionEn: "Complete: You (masc.) ... your ... is beautiful. (أَنْتَ + حَقِيبَة)",
        type: "mcq",
        options: [
          { ar: "حَقِيبَتِي", en: "ḥaqībatī (my bag)" },
          { ar: "حَقِيبَتُكِ", en: "ḥaqībatuki (your bag - fem.)" },
          { ar: "حَقِيبَتُكَ", en: "ḥaqībatuka (your bag - masc.)" },
        ],
        correctAnswer: 2,
      },
      {
        id: 19,
        questionAr: "أَكْمِلْ: أَنْتِ ______ نَظِيفٌ.",
        questionEn: "Complete: You (fem.) ... your ... is clean. (أَنْتِ + قَلَم)",
        type: "mcq",
        options: [
          { ar: "قَلَمُكَ", en: "qalamuka (your pen - masc.)" },
          { ar: "قَلَمُكِ", en: "qalamuki (your pen - fem.)" },
          { ar: "قَلَمُهُ", en: "qalamuhu (his pen)" },
        ],
        correctAnswer: 1,
      },
      {
        id: 20,
        questionAr: "أَكْمِلْ: هُوَ ______ وَاسِعٌ.",
        questionEn: "Complete: He ... his ... is spacious. (هُوَ + بَيْت)",
        type: "mcq",
        options: [
          { ar: "بَيْتُهَا", en: "baytuhā (her house)" },
          { ar: "بَيْتِي", en: "baytī (my house)" },
          { ar: "بَيْتُهُ", en: "baytuhu (his house)" },
        ],
        correctAnswer: 2,
