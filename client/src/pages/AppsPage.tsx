      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-4xl">
        ...
        >
          ...
          <motion.div custom={1} variants={fadeUp} initial="hidden" animate="visible">
            <Link href="/apps/quiz-generator">
              <div className="group relative bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer border border-gray-100 hover:border-blue-200 hover:-translate-y-1">
                <div className="h-40 bg-gradient-to-br from-[#0a2e6e] via-[#1641a3] to-[#2563eb] flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 opacity-20">
                    <div className="absolute top-4 right-4 w-20 h-20 rounded-full bg-white/20 blur-2xl" />
                    <div className="absolute bottom-4 left-4 w-16 h-16 rounded-full bg-white/15 blur-2xl" />
                  </div>
                  <div className="text-center relative z-10">
                    <Sparkles size={48} className="text-white mx-auto mb-2" />
                    <p className="text-white font-bold text-lg" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                      مولّد الألعاب التعليمية
                    </p>
                    <p className="text-white/70 text-xs">AI Quiz Generator</p>
                  </div>
                </div>
                <div className="p-5">
                  <p className="text-gray-600 text-sm leading-relaxed" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                    حوّل أسئلتك إلى لعبة تعليمية تفاعلية بالذكاء الاصطناعي
                  </p>
                  <div className="mt-3 flex items-center gap-2 text-blue-600 font-medium text-sm group-hover:gap-3 transition-all" style={{ fontFamily: "'Tajawal', sans-serif" }}>
                    <span>افتح الأداة</span>
                    <span className="transform rotate-180">→</span>
                  </div>
                </div>
